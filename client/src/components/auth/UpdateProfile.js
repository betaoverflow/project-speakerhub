...
class Register extends Component {
  ...
  componentDidMount() {
    ...
    .then(res=>{
        ...
        this.setState({...data,past_talks:data.past_talks[0] ,
        past_talks2: data.past_talks[1],
        past_talks3: data.past_talks[2],
        past_talks4: data.past_talks[3],
        password:'',    //to be changed
        password2:'',   //to be changed
    })
        console.log(data)
    })
    .catch(err=>
